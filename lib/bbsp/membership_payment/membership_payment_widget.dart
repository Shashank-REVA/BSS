                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_model.radioButtonValue1 == 'Gold')
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 15.0, 0.0, 15.0),
                          child: ClipRRect(
                      ...
                      if (_model.radioButtonValue1 == 'Silver')
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 15.0, 0.0, 15.0),
                          child: ClipRRect(
                      ...
                      if (_model.radioButtonValue1 == 'General')
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 15.0, 0.0, 15.0),
                          child: ClipRRect(
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'MEMBERSHIP_PAYMENT_GET_STARTED_BTN_ON_TA');
                              ...
                              await MembershipRecord.collection
                                  ...
                                  .set(createMembershipRecordData(
                                    ...
                                    type: _model.radioButtonValue1,
                                    permanentAddress:
                                        _model.addressController.text,
                                    mobileNo: int.tryParse(
                                        _model.phonenumberController1.text),
                                    whatsappNo: _model.radioButtonValue2 ==
                                            'Yes'
                                        ? int.tryParse(
                                            _model.phonenumberController1.text)
                                        : int.tryParse(
                                            _model.phonenumberController2.text),
                                    emailId: _model.emailAddressController.text,
                                    date: getCurrentTimestamp,
                                    paymentScreenshot: _model.uploadedFileUrl,
                                  ));
                              logFirebaseEvent('Button_navigate_to');
