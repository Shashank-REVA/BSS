                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'HEALTHCARE_PAGE_HOME_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_navigate_to');
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'HEALTHCARE_PAGE_CITIES_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_navigate_to');
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'HEALTHCARE_PAGE_ACCOUNT_BTN_ON_TAP');
                                          if (loggedIn) {
                                            logFirebaseEvent(
                                                'Button_navigate_to');
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'HEALTHCARE_PAGE_EVENTS_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_navigate_to');
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'HEALTHCARE_PAGE_facilities_ON_TAP');
                                          logFirebaseEvent(
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'HEALTHCARE_PAGE_DONATION_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_navigate_to');
